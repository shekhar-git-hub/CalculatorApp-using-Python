...
class calculator:
    ...
    def __init__(self, gui):
        ...
        #Entry
        self.entry = Entry(gui, fg = "green")
        self.entry.grid(row = 0, column = 0, columnspan = 4)

        #Buttons
        bAC = Button(gui, text = "AC", width = 17, height=3, fg = "red",
        ...
        bEquals = Button(gui, text = "=", width = 5, height=3, fg = "green",
